...
function toggle_payload(pld){
	if(pld == "exploit"){
		...
		document.getElementById("progress").innerHTML="Carregando LINUX 3GB... <font color=\"#F00\">AGUARDE!!!</font>";
		preloadScripts(['payloads/preloader.js', 'payloads/linux3g.js', 'payloads/loader.js']);
	}else if(pld == "orbistoolbox"){
		document.getElementById("progress").innerHTML="Carregando Orbis Toolbox FW 7.55... <font color=\"#F00\">AGUARDE!!!</font>";
